    ...
    render(){
        return(
            ...
            <View style={{flex: 1, backgroundColor: '#1A1B29'}}>
                ...
                <View>
                    <Image style = {{  marginLeft: 70, marginBottom: 10, width: 346, height: 247, borderRadius: 110 }} source = { require('../assets/Coperta_Istorie.jpg') } />
                </View>
                <ScrollView style={{flex: 1, marginRight: 25, marginLeft: 15}}>
                    <Text style={{ textAlign: 'justify' , fontSize: 28, fontStyle: 'italic', fontWeight: 'bold', color: 'beige', paddingLeft: 10 }}>Early history</Text>
                    <Text style={{ textAlign: 'justify' , fontSize: 18, color: 'beige', top: 20, paddingLeft: 10 }}>     The region bounded by the Mureș, the Tisza and the Danube was very fertile and offered favorable conditions for food and human livelihood yet in 4000 BC. Archeological remains attested the presence of a population of farmers, hunters and artisans, whose existence was favored by mild climate, fertile soil and abundant water and forests.
