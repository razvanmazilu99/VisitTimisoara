    ...
    render(){
        return(
            ...
            <View style={{flex: 1, backgroundColor: '#1A1B29'}}>
                ...
                <View>
                    <TouchableOpacity onPress={ () => this.props.navigation.navigate('History') } style={styles.loginButton}>
                        <Text style={{color: 'white', fontSize: 26, textAlign: 'center', top: 8, fontWeight: 'bold'}}>Guided Tours</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={ () => this.props.navigation.navigate('History') } style={ [styles.loginButton, {top: 70}]}>
                        <Text style={{color: 'white', fontSize: 26, textAlign: 'center', top: 8, fontWeight: 'bold'}}>Create your tour</Text>
                    </TouchableOpacity>
                </View>
            </View>
